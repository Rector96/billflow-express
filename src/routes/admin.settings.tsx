    ...
    <AdminShell title="Settings" subtitle="Operational configuration notes">
      <div className="space-y-4 text-sm">
        ...
        <div className="rounded-2xl border bg-card p-4 shadow-card">
          ...
          <p className="mt-1 text-muted-foreground">
            Manage margins via SQL on <code>pricing_rules</code> (see seed migration) until the Settings editor is
            enabled. Default markups: airtime ₦5, data ₦10, cable ₦20, electricity ₦25.
          </p>
        </div>
      </div>
    </AdminShell>
