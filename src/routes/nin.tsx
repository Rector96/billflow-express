/**
 * Route: /nin — preview opens NinServicesFlow; production uses isBillLive.
 */
...
export const Route = createFileRoute("/nin")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "NIN retrieval and related helpers on RockPay.",
      },
    ],
  }),
  loader: async () => {
    ...
    <AppShell>
      ...
      <div className="mx-auto flex max-w-md flex-col items-center px-4 py-14 text-center">
        ...
        <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
          Preview is off. Connect an authorized provider or enable hub preview to walk the UI.
        </p>
      </div>
    </AppShell>
  );
