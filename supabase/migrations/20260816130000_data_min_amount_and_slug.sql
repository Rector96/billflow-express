-- Allow low catalogue amounts for Data packs (sandbox can be under N50).
-- Keeps cable/electricity practical mins via product catalogue / meter min.
-- Also ensures service_slug 'data' is allowed.
...
BEGIN
  ...
  -- Data catalogue packs can be under 50 on sandbox; other services keep 50 floor
  min_amt := CASE WHEN slug = 'data' THEN 1 ELSE 50 END;
