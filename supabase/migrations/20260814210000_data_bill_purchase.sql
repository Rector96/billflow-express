-- Phase 4C: Enable mobile Data purchases via the generic bill settlement path.
-- ADDITIVE: only widens allowed service_slug; does not change airtime RPCs.
...
BEGIN
  ...
  -- cable, electricity, data (mobile data bundles via VTpass)
